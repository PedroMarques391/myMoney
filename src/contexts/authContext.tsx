...
interface IAuthContextInterface {
    ...
    loadingAuth: boolean
    logout(): Promise<void>
    updateProfile: (url: string, name: string, work: string, phone: string) => Promise<void>
}
...
function AuthProvider({ children }: AuthProviderProps) {
    ...
    async function updateProfile(url: string, name: string, work: string, phone: string) {
        const dataRef = ref(db, `users/${user?.uid}`)
